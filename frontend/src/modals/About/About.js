    ...
    return (
        <div className='About'>
            <div className='description'>
                {SITE_NAME} is an online real-time multiplayer game where up to 20 players compete in an arena by collecting and attempting to retain coins until one player is left.
            </div>
            ...
            <div className='howToPlay'>
                ...
                <div>Click "Create Game" -> Choose your game settings -> Wait for players to join your lobby -> Click "Start Game"</div>

                <div className='subtitle'>Joining a game</div>
                <div>Click "Join Game" -> Select a lobby to join -> Wait for the host to start the game</div>

                <div className='subtitle'>Gameplay</div>
                <div>Move your player with the left/right/up/down arrow keys. Collect coins and power-ups that spawn on the arena!</div>
